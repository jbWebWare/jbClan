...
<div style='width:100%'>
    <form action='admin_member_edit.php' method='POST'>
        <table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
            ...
            $numRows = $sql->db_Count(DB_TABLE_ROSTER_MEMBERS, "(*)", "WHERE member_status like 'Closed Application%' ");
            if ($numRows == 0) {
                $text .= "
                <tr>
                    <td colspan='10' class='forumheader3'>
                        <center>
                            <p>
                                ".LAN_JBROSTER_ADMIN_CLOSED_APPS_NO_CLOSED_APPS."
                            </p>
                        </center>
                    </td>
                </tr>";
            ...
            $sql->db_Select(DB_TABLE_ROSTER_MEMBERS, "*", "member_status like 'Closed Application%' ");
...
$title = "<b>".LAN_JBROSTER_GENERAL_CLOSED_APPS."</b>";
