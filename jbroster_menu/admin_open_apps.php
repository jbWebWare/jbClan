...
<div style='width:100%'>
    <form action='admin_member_edit.php' method='POST'>
        <table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
            ...
            $numRows = $sql->db_Count(DB_TABLE_ROSTER_MEMBERS, "(*)", "WHERE member_status like 'Open Application%' ");
            if ($numRows == 0) {
                $text .= "
                <tr>
                    <td colspan='10' class='forumheader3'>
                        <center>
                            <p>
                                ".LAN_JBROSTER_ADMIN_OPEN_APPS_NO_OPEN_APPS."
                            </p>
                        </center>
                    </td>
                </tr>";
            ...
            $sql->db_Select(DB_TABLE_ROSTER_MEMBERS, "*", "member_status like 'Open Application%' ");
            while($row = $sql->db_Fetch()) {
                ...
                <td class='forumheader3'>
                    ...
                    $sql1->db_Select(DB_TABLE_ROSTER_LEADER_STATUS, "*", "ORDER BY status_order", "no-where");
                    while ($row1 = $sql1->db_Fetch()) {
                ...
                <td class='forumheader3'>
                    ...
                    $sql1->db_Select(DB_TABLE_ROSTER_MEMBER_STATUS, "*", "ORDER BY status_order", "no-where");
                    while ($row1 = $sql1->db_Fetch()) {
                ...
                <td class='forumheader3'><a href='admin_member_edit.php?member_id=".$row['member_id']."&url=".$_SERVER['PHP_SELF']."'>".ADMIN_EDIT_ICON."</a></td>
                <td class='forumheader3'><a href='admin_member_edit.php?delete_member=1&member_id=".$row['member_id']."&url=".$_SERVER['PHP_SELF']."'><img src='".ADMIN_DELETE_ICON_PATH."' /></a></td>";
            }
            ...
            if ($numRows == 0) {
                ...
                <p>
                    ...
                    <center>
                        <input type='submit' class='button' value='".LAN_JBROSTER_GENERAL_CHANGE_MEMBER_STATUS."' />
                    </center>
                </p>";
            }
...
$title = "<b>".LAN_JBROSTER_GENERAL_OPEN_APPS."</b>";
