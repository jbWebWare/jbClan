...
<div style='width:100%'>
    <form action='admin_member_edit.php' method='POST'>
        <table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
			...
			$sql->db_Select(DB_TABLE_ROSTER_MEMBERS, "*", "ORDER BY nickname", "no-where");
			while($row = $sql->db_Fetch()) {
			    ...
			    <td class='forumheader3'>
			        <a href='admin_member_edit.php?member_id=".$row['member_id']."&url=".$_SERVER['PHP_SELF']."'>".ADMIN_EDIT_ICON."</a>
			    </td>
			    <td class='forumheader3'>
			        <a href='admin_member_edit.php?delete_member=1&member_id=".$row['member_id']."&url=".$_SERVER['PHP_SELF']."'><img src='".ADMIN_DELETE_ICON_PATH."' /></a>
			    </td>";
			}
                ...
                <tr>
                    <td class='forumheader3'>
                        <center>
                            ...
                            <p>
                                ".LAN_JBROSTER_ADMIN_MANAGE_ROSTER_IMPORT_MEMBERS_NOTICE_1."
                            </p>
                            <p>
                                ".LAN_JBROSTER_ADMIN_MANAGE_ROSTER_IMPORT_MEMBERS_NOTICE_2."
                            </p>
                        </center>
                    </td>
                </tr>
...
$title = "<b>".LAN_JBROSTER_GENERAL_IMPORT_MEMBERS."</b>";
$ns->tablerender($title, $text1);
