...
<div style='width:100%'>
    <form action='admin_member_edit.php' method='POST'>
        <table style='width:100%' class='fborder' cellspacing='0' cellpadding='0'>
            ...
            $numRows = $sql->db_Count(DB_TABLE_ROSTER_MEMBERS, "(*)", "WHERE member_status like 'Inactive Member%' ");
            if ($numRows == 0) {
                $text .= "
                <tr>
                    <td colspan='10' class='forumheader3'>
                        <center>
                            <p>
                                ".LAN_JBROSTER_ADMIN_INACTIVE_NO_INACTIVE_MEMBERS."
                            </p>
                        </center>
                    </td>
                </tr>";
            ...
            $sql->db_Select(DB_TABLE_ROSTER_MEMBERS, "*", "member_status like 'Inactive Member%' ");
...
$title = "<b>".LAN_JBROSTER_GENERAL_INACTIVE_MEMBERS."</b>";
